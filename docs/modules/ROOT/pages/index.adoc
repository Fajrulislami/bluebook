...
- xref:draft/now-open.adoc[Now Open]
  ** xref:draft/now-open/requirement.adoc[Persyaratan]
  ** xref:draft/now-open/interview.adoc[Wawancara]
  ** xref:draft/now-open/test.adoc[Tes]
- xref:draft/root.adoc[ROOT]
- xref:draft/learning.adoc[Learning]
  ** xref:draft/learning/candidate-member.adoc[Calon Anggota]
  ** xref:draft/learning/member.adoc[Anggota]
