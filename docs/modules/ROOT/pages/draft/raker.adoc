...
[NOTE]
Proker (Program Kerja) periode sebelumnya sebagai sebagai contoh atau landasan yang bersifat dinamis (*Update Periodik*) untuk beberapa jenis Proker. Proker yang wajib ada di terdapat pada menu di samping.
